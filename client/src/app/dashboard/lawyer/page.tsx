...
export default function LawyerDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "profile" | "leads" | "appointments" | "payout">("overview");
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#1B2A4A] tracking-tight">Lawyer Dashboard</h1>
        <p className="text-[#667085] mt-1">Welcome, {user.firstName} {user.lastName}</p>
      </div>

      {/* Tabs */}
      <div className="flex gap-1 mb-8 bg-[#EEF2F7] p-1 rounded-lg w-fit flex-wrap">
        {(["overview", "profile", "leads", "appointments", "payout"] as const).map((tab) => (
          <button key={tab} onClick={() => setActiveTab(tab)}
            className={`px-4 py-2 rounded-md text-sm font-medium capitalize transition-all ${activeTab === tab ? "bg-white text-[#1B2A4A] shadow-sm" : "text-[#667085] hover:text-[#1B2A4A]"}`}>{tab}</button>
        ))}
      </div>
      ...
      {activeTab === "leads" && (
        <div className="bg-white rounded-xl border border-[#E5EAF0]">
          <div className="p-6 border-b border-[#E5EAF0]"><h2 className="text-xl font-bold text-[#1B2A4A]">Client Enquiries</h2></div>
      ...
      {activeTab === "appointments" && (
        <div className="bg-white rounded-xl border border-[#E5EAF0]">
          <div className="p-6 border-b border-[#E5EAF0]"><h2 className="text-xl font-bold text-[#1B2A4A]">Appointments</h2></div>
      ...
      {activeTab === "payout" && (
        <div className="bg-white rounded-xl border border-[#E5EAF0] p-8 max-w-3xl">
          <h2 className="text-xl font-bold text-[#1B2A4A] mb-2">Payout Settings</h2>
          <p className="text-[#667085] mb-6 pb-3 border-b border-[#E5EAF0]">Add your bank account details to receive payouts for consultations.</p>
          <form onSubmit={handleProfileUpdate} className="space-y-5">
