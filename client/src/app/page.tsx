...
const HERO_IMAGE = 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&h=600&fit=crop&crop=faces';
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-accent">Why Advisora?</h2>
            <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
              We make it simple to find and connect with trusted legal professionals across Africa.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((item) => (
              <div key={item.title} className="bg-primary/5 border-2 border-primary/10 rounded-xl p-6 hover:border-primary/30 hover:shadow-lg transition-all group">
                <div className="text-3xl mb-4">{item.icon}</div>
                <h3 className="text-lg font-bold text-accent mb-2 group-hover:text-[#C5A55A] transition-colors">{item.title}</h3>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-primary/5 to-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((item) => (
              <div key={item.step} className="bg-white p-8 rounded-xl shadow-lg border-2 border-primary/10 text-center hover:shadow-xl hover:border-primary/30 transition-all">
                <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-5">
                  <span className="text-[#C5A55A] font-bold text-2xl">{item.step}</span>
                </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center mb-10">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-accent">Featured Lawyers</h2>
                <p className="text-gray-600 mt-2">Top-rated legal professionals on Advisora Connect</p>
              </div>
              <Link href="/lawyers" className="text-accent font-bold hover:underline">View All &rarr;</Link>
            </div>
